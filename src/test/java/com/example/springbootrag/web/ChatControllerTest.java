...
class ChatControllerTest {
    ...
    void aFilterFrameIsEmittedBeforeTheTokens() throws Exception {
        ...
        // Route comes first of all: it is what tells the reader whether a citation-free answer is
        // expected on this path or a problem.
        assertThat(body).contains("\"type\":\"route\"").contains("\"route\":\"search\"");
        assertThat(body.indexOf("\"type\":\"route\"")).isLessThan(body.indexOf("\"type\":\"filter\""));
    }
